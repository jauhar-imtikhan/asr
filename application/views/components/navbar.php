          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown messages-menu">
              ...
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <span class="label label-success"><?php echo $this->cart->total_items(); ?></span>
              </a>

              <ul class="dropdown-menu">
                <li class="header"><?php if ($this->cart->total_items() != 0) {
                                      echo "Jumlah Barang Di Keranjang : " . $this->cart->total_items();
                                    } else {
                                      echo '<span class="text-center">Tidak Ada Barang Dalam Keranjang!</span>';
                                    } ?></li>
                <li>
                  <!-- inner menu: contains the messages -->
                  <ul class="menu">
                    <?php foreach ($cart as $items) { ?>
                      <li><!-- start message -->
                        <a href="<?= site_url('keranjang/viewId/' . $items['rowid']) ?>">
                          <div class="pull-left">
                            <!-- User Image -->
                            <img src="<?= base_url('uploads/' . $items['foto']) ?>" class="img-circle" alt="User Image">
                          </div>
                          <!-- Message title and timestamp -->
                          <h4>
                            <?= $items['name'] ?>
                          ...
                          <!-- The message -->
                          <p><?= $items['qty'] ?> x <?= Rp($items['price']) ?></p>
                        </a>
                      </li>
                    <?php } ?>
                    <!-- end message -->
                ...
                <li class="footer text-blue"><a href="<?= site_url('keranjang/checkout') ?>">Check Out &rightarrow;</a></li>
              </ul>
            </li>
            <!-- /.messages-menu -->
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
            <ul class="nav navbar-nav">
              ...
              <li>
                <a href="<?= site_url('dashboard/payment/' . $this->session->userdata('userid')) ?>">Riwayat Pembayaran </a>
              </li>
            </ul>
            <form class="navbar-form navbar-left" role="search">
              <div class="form-group">
